...
<title>Sign Up Form by MohithReddy</title>
			...
			<div class="container">
				<div class="signup-content">
						...
						<form method="post" action="register" class="register-form"
							...
							<div class="form-group">
								<input type="checkbox" name="agree-term" id="agree-term"
									...
									agree all statements in <a href="https://en.wikipedia.org/wiki/Terms_of_service" class="term-service">Terms
										of service</a></label>
							</div>
					...
					<div class="signup-image">
						...
						<button class="signup-image-link" onclick="window.location.href='login.jsp';" >Already member</button>
					</div>
				</div>
			</div>
		</section>
